    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-white flex items-center justify-center flex-col">
          ...
          <p className="max-w-3xl text-lg text-blue-100 text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              ...
              innovation. However, this importance also makes them prime targets
              for cyber threats.
            </p>
          ...
          <div className="bg-blue-50 rounded-2xl p-12">
            ...
            <p className="text-gray-600 max-w-4xl mb-8">
              ...
              Cycle (SDLC) to identify and resolve risks early—before they reach
              production.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                industry and regulatory requirements while reducing operational
